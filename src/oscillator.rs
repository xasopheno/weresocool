...
//    #[test]
//    fn test_ratio() {
//        let r: R = R::atio(3, 2, 0.0, 1.0, Pan::Left);
//        let result = r.ratio;
//        let expected = "3/2";
...
//        let l = vec![R::atio(5, 4, 0.0, 1.0, Pan::Left), R::atio(1, 1, 0.0, 1.0, Pan::Left)];
//        let r = vec![R::atio(3, 2, 0.0, 1.0, Pan::Left), R::atio(1, 1, 0.0, 1.0, Pan::Left)];
//        let sr = StereoRatios {
//            l_ratios: l,
//            r_ratios: r,
//        };
