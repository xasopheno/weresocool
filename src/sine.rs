...
pub mod tests {
    ...
    fn test_sine_generator() {
        let expected = vec![
            0.0, 0.095018126, 0.19087751, 0.28651062, 0.38083696, 0.4727775, 0.56126946, 0.6452813, 0.7238264, 0.7959779
        ];
        let (result, _) = generate_waveform(
            441.0,
            &Gain::new(1.0, 1.1),
            &vec![R::atio(2, 1, 0.0, 1.0), R::atio(3, 2, 0.0, 1.0), R::atio(1, 1, 0.0, 1.0)],
            &vec![0.0, 0.0, 0.0],
            10,
            44100.0,
        );
