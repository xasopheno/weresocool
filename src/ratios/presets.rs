...
pub fn complicated_ratios() -> Vec<R> {
    vec![
        ...
        R::atio(2, 1, 4.0, 1.0, Pan::Right),
        R::atio(2, 1, 0.0, 1.0, Pan::Right),
        R::atio(7, 3, -3.0, 1.0, Pan::Right),
        R::atio(5, 4, 0.0, 1.0, Pan::Right),
        R::atio(1, 1, -2.0, 1.0, Pan::Right),
        R::atio(1, 1, 0.0, 1.0, Pan::Right),
