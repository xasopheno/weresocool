...
impl RenderOp {
    ...
    pub fn init_silent_with_length(l: f64) -> Self {
        Self {
            ...
            sustain: 1.0,
            release: Settings::global().sample_rate,
            asr: ASR::Long,
...
fn pointop_to_renderop(
    ...
    let render_op = RenderOp {
        ...
        sustain: r_to_f64(point_op.sustain).clamp(0.0, 2.0),
        release: r_to_f64(point_op.release * basis.d) * settings.sample_rate,
