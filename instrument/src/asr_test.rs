...
pub mod tests {
    ...
    fn short_gain_at_index(index: usize, silence_next: bool) -> f64 {
        ...
        calculate_short_gain(past_gain, current_gain, sustain, release, silence_next, index, attack_length, decay_length, total_length)
    }
    fn long_gain_at_index(index: usize, silence_now: bool) -> f64 {
        ...
        calculate_long_gain(past_gain, current_gain, sustain, release, silence_now, index, attack_length, decay_length, total_length)
    }
    ...
    fn test_calculate_long_gain_silence_now() {
        ...
        assert!(cmp_f64(long_gain_at_index(5, true), 0.75));
        assert!(cmp_f64(long_gain_at_index(10, true), 1.0));
    }
    #[test]
