export const welcome = `Welcome to WereSoCool!
...
¡¡¡WARNING!!!
This is new software and is still in flux. 
It will definitely change...hopefully for the better.
Sorry for any breaking changes.
